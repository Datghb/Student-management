...
<div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
            <img src="public/img/hinh-nen-may-tinh-4k-75.png" class="img-circle elevation-2" alt="User Image" style="height:40px;">
        </div>
        <div class="info">
            ...
            <form class="d-inline-block" method="post" action="index.php?c=login&m=logout">
                <button style="background-color: dodgerblue;" type="submit" class="border border-primary-subtle btn btn-success" name="btnLogout"> Logout </button>
            </form>
        </div>
    </div>
