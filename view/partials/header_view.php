...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="public/img/universitario.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar .bg-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="public/img/universitario.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8;width:auto;height:90px  ">
