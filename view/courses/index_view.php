                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group my-3">
                                ...
                                <a style="background-color:darkslategray" class="btn btn-info btn-sm border border-primary-subtle" href="index.php?c=course"> Back to list</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            <?php foreach ($courses as $key => $item) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a style="background-color:dodgerblue" class="btn btn-success border border-primary-subtle btn-sm .bg-primary.bg-gradient" href="index.php?c=course&m=edit&id=<?= $item['id']; ?>"> Edit</a>
                                    </td>
                                    <td>
